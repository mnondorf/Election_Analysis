...
county_names_list = []
county_votes_cast_dict = {}

# Track the winning candidate, vote count and percentage
winning_candidate = ""
overall_winning_count = 0
...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        if county_name not in county_names_list:
            ...
            county_votes_cast_dict[county_name] = 0

        # 5: Add a vote to that county's vote count.
        county_votes_cast_dict[county_name] +=1
...
with open(file_to_save, "w") as txt_file:
    ...
    for county in county_votes_cast_dict:                                        
                                                                                    
        # 6b: Retrieve the county vote count.                           
        votes = county_votes_cast_dict.get(county)            
    ...
    for candidate_name in candidate_votes_dict:
        ...
        if (votes > overall_winning_count) and (vote_percentage > winning_percentage):
            overall_winning_count = votes
    ...
    winning_candidate_summary = (
        ...
        f"Winning Vote Count: {overall_winning_count:,}\n"
